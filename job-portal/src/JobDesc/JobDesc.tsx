    ...
    return (
        <div className="flex" >
            ...
            <div className="space-y-8 m-10 ">
                <div className="text-2xl font-semibold text-white my-6">Jobs</div>
                <Divider size="xs" className="my-4" />
                {jobData.slice(0, 3).map((jobData, index) => (
                    <div
                        key={index}
                        className="w-full transform scale-105 transition-transform duration-300"
                    >
                        <JobCard {...jobData} />
                    </div>
                ))}
